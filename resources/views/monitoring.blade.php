    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <form method="POST" action="" enctype="multipart/form-data" class="add_user_form" id="export_btn">
                ...
                <!-- BEGIN: Vendor JS-->
                <script
                    src="https://uat.evirtualpay.com/vp_interface/includes_new/app-assets/vendors/js/vendors.min.js">
                </script>
                <!-- BEGIN Vendor JS-->
                ...
                <!-- BEGIN: Theme JS-->
                <script src="https://uat.evirtualpay.com/vp_interface/includes_new/app-assets/js/core/app-menu.js">
                </script>
                ...
                <script
                    src="https://uat.evirtualpay.com/vp_interface/includes_new/app-assets/js/scripts/pages/app-user.js">
                </script>
                <script
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js"></script>   -->
        ...
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script> -->
                ...
                function reload() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "https://uat.evirtualpay.com/vp_interface/dashboard/data/" + filter + "/" +
                            merchant_id,
